...
public class BinaryTreeInorderTraversal
{
    ...
    public IList<int> bestSolution1(TreeNode root)
    {
        if (root == null)
        {
            return ans;
    ...
    // Best Solution 2: Iterative with stack
    public IList<int> bestSolution2(TreeNode root)
    {
        List<int> result = new List<int>();
    ...
    public IList<int> bestSolution3(TreeNode root)
    {
        List<int> result = new List<int>();
