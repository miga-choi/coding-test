...
public:
    ...
    bool bestSolution1(TreeNode *p, TreeNode *q)
    {
    ...
    bool bestSolution2(TreeNode *p, TreeNode *q)
    {
    ...
    bool bestSolution3(TreeNode *p, TreeNode *q)
    {
    ...
    bool bestSolution4(TreeNode *p, TreeNode *q)
    {
        std::string hash1 = bestSolution4_computeTreeHash(p);
        std::string hash2 = bestSolution4_computeTreeHash(q);
        return hash1 == hash2;
    }

    std::string bestSolution4_computeTreeHash(TreeNode *node)
    {
        if (node == nullptr)
        {
            return "null";
        }
        std::string leftHash = bestSolution4_computeTreeHash(node->left);
        std::string rightHash = bestSolution4_computeTreeHash(node->right);
